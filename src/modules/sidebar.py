...
class Sidebar:
    ...
    @staticmethod
    def about():
        about = st.sidebar.expander("🧠 About StockChat ")
        sections = [
            "#### StockChat is an AI chatbot with a conversational memory, designed to allow users to discuss their data in a more intuitive way. 📄",
    ...
    def show_options(self):
        with st.sidebar.expander("🛠️ Stockchat's Tools", expanded=False):
